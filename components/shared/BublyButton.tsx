      ...
      const handleClick = () => {
            ...
            return (
                              ...
                              <div className="demo__drone-cont demo__drone-cont--landing">
                                    <svg viewBox="0 0 136 112" className="demo__drone">
                                          <g className="demo__drone-leaving">
                                                <path className="demo__drone-arm" d="M52,46 c0,0 -15,5 -15,20 l15,10" />
                                                <path className="demo__drone-arm demo__drone-arm--2" d="M52,46 c0,0 -15,5 -15,20 l15,10" />
                                                <path className="demo__drone-yellow"
                                                      d="M28,36 l20,0 a20,9 0,0,1 40,0 l20,0 l0,8 l-10,0 c-10,0 -15,0 -23,10 l-14,0 c-10,-10 -15,-10 -23,-10 l-10,0z" />
                                                <path className="demo__drone-green" d="M16,12 a10,10 0,0,1 20,0 l-10,50z" />
                                                <path className="demo__drone-green" d="M100,12 a10,10 0,0,1 20,0 l-10,50z" />
                                                <path className="demo__drone-yellow" d="M9,8 l34,0 a8,8 0,0,1 0,16 l-34,0 a8,8 0,0,1 0,-16z" />
                                                <path className="demo__drone-yellow" d="M93,8 l34,0 a8,8 0,0,1 0,16 l-34,0 a8,8 0,0,1 0,-16z" />
                                          </g>
                                          <path className="demo__drone-package demo__drone-green" d="M50,70 l36,0 l-4,45 l-28,0z" />
                                    </svg>
                              </div>
                        </div>
                  </div>
                  ...
                  <div className="demo__text-fields">
                        <div className="demo__text demo__text--step-0" style={{ color: 'black' }}>Open Resume</div>
